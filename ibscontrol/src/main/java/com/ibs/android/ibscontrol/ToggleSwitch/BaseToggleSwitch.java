package com.ibs.android.ibscontrol.ToggleSwitch;
...
public abstract class BaseToggleSwitch extends LinearLayout implements View.OnClickListener {
    ...
    private FrameLayout toggleSwitchesSelectedContainer;
    ...
    public void setToggleHeight(float toggleHeight) {
    ...
    private void addToogleBtn(String text) {
        ...
        //Set toggle button text and size
        ...
        //Add toggle button to toggle control
